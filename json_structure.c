...
#define JSON_BUFFER_SIZE 32768 // 32KB buffer awal
...
// Helper function untuk membersihkan string dari whitespace yang tidak perlu
    ...
    MonitorList *monitorList)
{
    ...
    // Tambahkan informasi setiap komponen
    if (gpuList)
